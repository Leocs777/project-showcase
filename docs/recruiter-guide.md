...
This repository is a short, safe portfolio view of selected projects. It is optimized for fast screening rather than full source-code review.
...
- Full private app source code
- Secrets, API keys, or local config files
...
- App Store launch checklist summary
